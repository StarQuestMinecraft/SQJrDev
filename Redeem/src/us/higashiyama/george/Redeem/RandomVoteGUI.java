...
public class RandomVoteGUI implements Listener {
	...
	public RandomVoteGUI(String name, int size, OptionClickEventHandler handler, Plugin plugin) {
	...
	public RandomVoteGUI setOption(int position, ItemStack icon, String name, String... info) {
